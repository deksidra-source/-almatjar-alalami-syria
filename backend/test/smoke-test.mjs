...
const requiredHome = ['المتجر العالمي سوريا', 'province-filter', 'shipping-filter', 'legal-consent', 'الحساب', 'الدردشة', 'promotion-form', 'غير محدد', 'يحدد المدير السعر', 'value="manual" checked', 'value="shamcash" disabled', 'value="icash" disabled'];
const requiredStore = ['product-code', 'product-price', 'product-quantity', 'shipping-policy', 'localStorage'];
const requiredAdmin = ['طلبات الإعلان المروّج', 'أسعار الإعلان المروّج', 'حفظ أسعار الإعلان', 'معرّف حساب المدير'];
